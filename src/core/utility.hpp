#ifndef IMAGE_CONVOLUTIONS_ALGORITHMS_CORE_UTILITY_HPP
#define IMAGE_CONVOLUTIONS_ALGORITHMS_CORE_UTILITY_HPP
...
#endif /// IMAGE_CONVOLUTIONS_ALGORITHMS_CORE_UTILITY_HPP.
